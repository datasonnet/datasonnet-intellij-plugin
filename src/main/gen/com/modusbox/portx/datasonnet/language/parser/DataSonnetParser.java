...
package com.modusbox.portx.datasonnet.language.parser;
...
public class DataSonnetParser implements PsiParser, LightPsiParser {
  ...
  public void parseLight(IElementType t, PsiBuilder b) {
    ...
    if (t == DataSonnetTypes.IDENTIFIER_0) {
      r = IDENTIFIER0(b, 0);
    }
    else if (t == DataSonnetTypes.APPLY) {
      r = apply(b, 0);
    }
    else if (t == DataSonnetTypes.ARG) {
      r = arg(b, 0);
    }
    else if (t == DataSonnetTypes.ARGS) {
      r = args(b, 0);
    }
    else if (t == DataSonnetTypes.ARR) {
      r = arr(b, 0);
    }
    else if (t == DataSonnetTypes.ARRCOMP) {
      r = arrcomp(b, 0);
    }
    else if (t == DataSonnetTypes.ASSERT_STMT) {
      r = assertStmt(b, 0);
    }
    else if (t == DataSonnetTypes.BINARYOP) {
      r = binaryop(b, 0);
    }
    else if (t == DataSonnetTypes.BIND) {
      r = bind(b, 0);
    }
    else if (t == DataSonnetTypes.BINSUFFIX) {
      r = binsuffix(b, 0);
    }
    else if (t == DataSonnetTypes.COMPSPEC) {
      r = compspec(b, 0);
    }
    else if (t == DataSonnetTypes.EXPR) {
      r = expr(b, 0);
    }
    else if (t == DataSonnetTypes.EXPR_0) {
      r = expr0(b, 0);
    }
    else if (t == DataSonnetTypes.FIELD) {
      r = field(b, 0);
    }
    else if (t == DataSonnetTypes.FIELDNAME) {
      r = fieldname(b, 0);
    }
    else if (t == DataSonnetTypes.FORSPEC) {
      r = forspec(b, 0);
    }
    else if (t == DataSonnetTypes.H) {
      r = h(b, 0);
    }
    else if (t == DataSonnetTypes.IFSPEC) {
      r = ifspec(b, 0);
    }
    else if (t == DataSonnetTypes.IMPORTOP) {
      r = importop(b, 0);
    }
    else if (t == DataSonnetTypes.IMPORTSTROP) {
      r = importstrop(b, 0);
    }
    else if (t == DataSonnetTypes.INSUPER) {
      r = insuper(b, 0);
    }
    else if (t == DataSonnetTypes.MEMBER) {
      r = member(b, 0);
    }
    else if (t == DataSonnetTypes.OBJ) {
      r = obj(b, 0);
    }
    else if (t == DataSonnetTypes.OBJEXTEND) {
      r = objextend(b, 0);
    }
    else if (t == DataSonnetTypes.OBJINSIDE) {
      r = objinside(b, 0);
    }
    else if (t == DataSonnetTypes.OBJLOCAL) {
      r = objlocal(b, 0);
    }
    else if (t == DataSonnetTypes.OUTERLOCAL) {
      r = outerlocal(b, 0);
    }
    else if (t == DataSonnetTypes.PARAM) {
      r = param(b, 0);
    }
    else if (t == DataSonnetTypes.PARAMS) {
      r = params(b, 0);
    }
    else if (t == DataSonnetTypes.SELECT) {
      r = select(b, 0);
    }
    else if (t == DataSonnetTypes.SLICE) {
      r = slice(b, 0);
    }
    else if (t == DataSonnetTypes.SLICESUFFIX) {
      r = slicesuffix(b, 0);
    }
    else if (t == DataSonnetTypes.UNARYOP) {
      r = unaryop(b, 0);
    }
    else {
      r = parse_root_(t, b, 0);
  ...
  // ( ELSE expr )?
  private static boolean expr0_17_4(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "expr0_17_4")) return false;
    expr0_17_4_0(b, l + 1);
    return true;
  }

  // ELSE expr
  private static boolean expr0_17_4_0(PsiBuilder b, int l) {
  ...
  private static boolean objinside_1(PsiBuilder b, int l) {
    ...
    Marker m = enter_section_(b);
    r = member(b, l + 1);
    r = r && objinside_1_1(b, l + 1);
    r = r && objinside_1_2(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }

  // ( COMMA member )*
  private static boolean objinside_1_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "objinside_1_1")) return false;
    while (true) {
      int c = current_position_(b);
      if (!objinside_1_1_0(b, l + 1)) break;
      if (!empty_element_parsed_guard_(b, "objinside_1_1", c)) break;
    }
    return true;
  }

  // COMMA member
  private static boolean objinside_1_1_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "objinside_1_1_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = GeneratedParserUtilBase.consumeToken(b, DataSonnetTypes.COMMA);
    r = r && member(b, l + 1);
  ...
  // ( COMMA )?
  private static boolean objinside_1_2(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "objinside_1_2")) return false;
    GeneratedParserUtilBase.consumeToken(b, DataSonnetTypes.COMMA);
    return true;
  }

...
public class DataSonnetObjImpl extends ASTWrapperPsiElement implements DataSonnetObj {

  public DataSonnetObjImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public DataSonnetObjinside getObjinside() {
    return findChildByClass(DataSonnetObjinside.class);
  }

...
import io.portx.datasonnet.language.psi.DataSonnetBinaryop;
import io.portx.datasonnet.language.psi.DataSonnetBinsuffix;
...
public class DataSonnetBinsuffixImpl extends ASTWrapperPsiElement implements DataSonnetBinsuffix {

  public DataSonnetBinsuffixImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public DataSonnetBinaryop getBinaryop() {
    return findNotNullChildByClass(DataSonnetBinaryop.class);
  }
